...
export const CaruoselItemContent =
  {
    [CarouselItemType.FAMILY]: {
      ...
      image_address: '/public/images/homepage/family-gathering',
    },
    ...
    [CarouselItemType.SOCIAL]: {
      ...
      image_address: '/public/images/homepage/social-events',
    },
    ...
    [CarouselItemType.SPECIAL]: {
      ...
      image_address: '/public/images/homepage/special-events',
    }    
  }
;
